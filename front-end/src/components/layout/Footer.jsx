...
/**
 * Footer Component
 * Website footer with navigation, newsletter, and social links
 */
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Foresite</span>
            </Link>
            ...
            <div>
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 bg-neutral-800 text-white border border-neutral-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                />
                <Button
                  type="submit"
                  variant="primary"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <a href={`mailto:${SITE_CONFIG.CONTACT_EMAIL}`} className="text-sm text-neutral-400 hover:text-white">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <a href={`tel:${SITE_CONFIG.CONTACT_PHONE}`} className="text-sm text-neutral-400 hover:text-white">
